...
const Navbar = () => {
  ...
  const adminNavLinks = [
    ...
    { to: '/admin/add-scholarship', label: 'Add Scholarship', icon: '➕' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group min-w-0">
            ...
            <span className="text-xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hidden sm:block truncate">
              ScholarConnect
            </span>
          </Link>
            ...
            {user ? (
              <>
                ...
                {user.role !== 'admin' ? (
                  ...
                  <span className="hidden sm:inline-flex px-3 py-2 rounded-lg text-xs font-semibold bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300">
                    Admin Mode
                  </span>
                )}
                ...
                <div className="relative" ref={profileRef}>
                  <button
                    ...
                    className="flex items-center gap-2 pl-2 pr-2 sm:pr-3 py-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all"
                    id="profile-menu-btn"
                  >
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <Link to="/register" className="btn-primary text-sm py-2 px-3 sm:px-4" id="register-btn">
                  Get Started
                </Link>
              </div>
            )}
